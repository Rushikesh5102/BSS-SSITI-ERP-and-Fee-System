...
function FeeStructuresContent() {
    ...
    const addItem = () => setForm(f => ({ ...f, items: [...f.items, { feeCategoryId: '', amount: '' }] }));
        ...
        <div className="layout">
            ...
            <div className="main-content">
                <header className="header">
                    ...
                    {canEdit && (
                        <button className="btn btn-primary" onClick={() => setShowModal(true)}>➕ Create Structure</button>
                    )}
                </header>
                ...
                <div className="page-content">
                    {structures.length === 0 ? (
                        <div className="card" style={{ padding: 60, textAlign: 'center' }}>
                            ...
                            {canEdit && <button className="btn btn-primary" style={{ margin: '16px auto 0', display: 'flex' }} onClick={() => setShowModal(true)}>Create First Structure</button>}
                        </div>
                    ) : (
                ...
                <div className="modal-overlay" onClick={() => setShowModal(false)}>
                    <div className="modal" style={{ maxWidth: 600 }} onClick={(e) => e.stopPropagation()}>
                        <div className="modal-header">
                            <div className="modal-title">➕ Create Fee Structure</div>
