...
const galleryItems = [
  {
    ...
    title: 'Practical Trade Workshop',
    subtitle: 'Hands-on training with industrial machinery & electrical setups.',
    tag: 'Electrical Trade Lab',
  },
  {
    image: '/gallery/gallery_2.jpg',
    title: 'Advanced Electronics & Testing Lab',
    subtitle: 'Precision circuit testing, digital meters & electronic workstations.',
    tag: 'Electronics Lab',
  },
  {
    image: '/gallery/gallery_3.jpg',
    title: 'Mechanical & Fitter Machining Lab',
    subtitle: 'Machining, lathe operations & mechanical trade precision tools.',
    tag: 'Fitter Trade Workshop',
  },
  {
    image: '/gallery/gallery_4.jpg',
    title: 'Institutional Campus Facilities',
    subtitle: 'Safe, spacious technical learning environment in Bhadrawati.',
    tag: 'Campus Infrastructure',
  },
  {
    image: '/gallery/gallery_5.jpg',
    title: 'Electrical Control Panel Setup',
    subtitle: 'High-voltage safety & industrial motor control wiring panels.',
    tag: 'Electrical Workstation',
  },
  {
    image: '/gallery/gallery_6.jpg',
    title: 'Student Technical Workshop',
    subtitle: 'Practical skill development guided by experienced instructors.',
    tag: 'Hands-on Practical',
  },
  {
    image: '/gallery/gallery_7.jpg',
    title: 'Computer CAD & Design Center',
    subtitle: 'Technical drafting software, CAD design & digital literacy.',
    tag: 'Computer Laboratory',
  },
  {
    image: '/gallery/gallery_8.jpg',
    title: 'Trade Machine Shop & Equipment',
    subtitle: 'Modern industrial machinery equipped for real-world practice.',
    tag: 'Machine Shop',
  },
  {
    image: '/gallery/gallery_9.jpg',
    title: 'Faculty Mentorship & Guidance',
    subtitle: 'Individual instructor attention ensuring trade mastery.',
    tag: 'Faculty Guidance',
  },
  {
    image: '/gallery/gallery_10.jpg',
    title: 'Student Practical Examination Lab',
    subtitle: 'Preparing students for NCVT trade certification success.',
    tag: 'Skill Certification',
  },
  {
    image: '/gallery/gallery_11.jpg',
    title: 'Motor Control & Transformer Lab',
    subtitle: 'Industrial motor control, switchgear & transformer testing.',
    tag: 'Motor Wiring Lab',
  },
  {
    image: '/gallery/gallery_12.jpg',
    title: 'Industrial Safety Workshop',
    subtitle: 'Comprehensive trade safety standards & protective equipment.',
