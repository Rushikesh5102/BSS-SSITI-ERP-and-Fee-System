...
const INITIAL_BOOKS_SEED: BookItem[] = [
    {
        id: 'book-101',
        title: 'Basic Electrical Engineering & Workshop Practice',
        ...
        language: 'English',
        shelfLocation: 'Shelf A-01 (Electrical Bay)',
        quantity: 15,
        availableCopies: 12,
        issuedCopies: 3,
        lostCopies: 0,
        ...
        status: 'AVAILABLE',
        isActive: true,
        notes: 'Mandatory textbook for ITI Electrician Trade students.'
    },
    {
        id: 'book-102',
        title: 'Workshop Technology & Machine Tool Operations',
        author: 'S.K. Hajra Choudhury',
        publisher: 'Media Promoters & Publishers',
        isbn: '978-8185099156',
        category: 'Mechanical',
        edition: '14th Revised Edition',
        language: 'English',
        shelfLocation: 'Shelf M-03 (Mechanical Wing)',
        quantity: 10,
        availableCopies: 8,
        issuedCopies: 2,
        lostCopies: 0,
        ...
        status: 'AVAILABLE',
        isActive: true,
        notes: 'Covers lathe, milling, shaping, grinding & CNC fundamentals.'
    },
    {
        id: 'book-103',
        ...
        language: 'English',
        shelfLocation: 'Shelf E-02 (Electronics Lab)',
        quantity: 8,
        availableCopies: 5,
        issuedCopies: 3,
        lostCopies: 0,
        ...
        status: 'AVAILABLE',
        isActive: true,
        notes: 'Reference guide for Electronic Mechanic Trade.'
    },
    {
        id: 'book-104',
        title: 'Computer Hardware & Networking Essentials',
        author: 'K.L. James',
        ...
        edition: '5th Edition',
        language: 'English',
        shelfLocation: 'Shelf C-01 (Computer Lab)',
        quantity: 12,
        availableCopies: 10,
        issuedCopies: 2,
        lostCopies: 0,
        ...
        status: 'AVAILABLE',
        isActive: true,
        notes: 'COPA (Computer Operator & Programming Assistant) core manual.'
    },
    {
        id: 'book-105',
        title: 'Engineering Drawing & Trade Theory for ITI',
        author: 'N.D. Bhatt',
        ...
        shelfLocation: 'Shelf D-04 (Drawing Hall)',
        quantity: 20,
        availableCopies: 16,
        issuedCopies: 4,
        lostCopies: 0,
        ...
        status: 'AVAILABLE',
        isActive: true,
        notes: 'Standard text for technical drawing & projections.'
    },
    {
        id: 'book-106',
        title: 'General Knowledge & Current Affairs 2025-26',
        ...
        language: 'Hindi',
        shelfLocation: 'Shelf GK-01 (Reading Room)',
        quantity: 6,
        availableCopies: 4,
        issuedCopies: 2,
        lostCopies: 0,
        ...
        status: 'AVAILABLE',
        isActive: true,
        notes: 'General awareness and competitive prep guide.'
    },
    {
        id: 'book-107',
        title: 'RRB ITI Apprentice & Loco Pilot Recruitment Exam Guide',
        ...
        shelfLocation: 'Shelf CE-02 (Career Corner)',
        quantity: 5,
        availableCopies: 0,
        issuedCopies: 5,
        lostCopies: 0,
        ...
        status: 'OUT_OF_STOCK',
        isActive: true,
        notes: 'High demand book for Railway ALP exam preparation.'
    }
];
    ...
    useEffect(() => {
        ...
        api.get('/students').then(({ data }) => {
            if (isMounted && data.data && Array.isArray(data.data) && data.data.length > 0) {
                ...
                setStudents([
                    { id: 'std-1', name: 'Rushikesh Pattiwar', rollNumber: 'SAI-2024-001', trade: 'Electrician', mobile: '+91 9876543210' },
                    { id: 'std-2', name: 'Amol Deshmukh', rollNumber: 'SAI-2024-014', trade: 'Fitter', mobile: '+91 9123456789' },
                    { id: 'std-3', name: 'Vikas Kadam', rollNumber: 'SAI-2024-022', trade: 'COPA', mobile: '+91 9988776655' }
                ]);
            }
        }).catch(() => {
            if (isMounted) {
