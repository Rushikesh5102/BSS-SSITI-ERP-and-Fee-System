...
const INITIAL_CAMPAIGNS_SEED: CampaignGoal[] = [
  { id: '1', title: 'Student Scholarships Fund', category: 'Scholarships', targetAmount: 500000, collectedAmount: 0, donorsCount: 0, status: 'Active', description: 'Empowering deserving rural ITI students with 100% tuition grant aid.' },
  { id: '2', title: 'Workshop Machinery Upgrade', category: 'Machinery', targetAmount: 800000, collectedAmount: 0, donorsCount: 0, status: 'Active', description: 'Procuring heavy-duty lathes, CNC simulators, and precision tools for workshop.' },
  { id: '3', title: 'Computer CAD Laboratory', category: 'IT & Software', targetAmount: 400000, collectedAmount: 0, donorsCount: 0, status: 'Active', description: 'Equipping modern workstation terminals with AutoCAD and Drafting suites.' },
  { id: '4', title: 'Library Book Expansion', category: 'Books', targetAmount: 200000, collectedAmount: 0, donorsCount: 0, status: 'Active', description: 'Adding technical engineering manuals and bilingual trade reference textbooks.' },
];
